...
for beam_n in [1, 2]:
    ...
    dict_intervals['he_before_SB']['t_end'] = dict_fill_bmodes[filln]['t_start_ADJUST']
    ...
    n_bins_emit = 50
    list_labels = ['Injected', 'Start Ramp', 'End Ramp', 'Start Adj.']
...
fig_inten_bbb.suptitle('Fill %d: started on %s'%(filln, tref_string), fontsize=myfontsz)
fig_inten_bbb.savefig('emit_hist_plots/brightbbb_fill_%d.png'%filln, dpi=200)
